...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String rollnum= contactDetailsPanel.getCityField().getText ();
            flag = validate();
            if(flag)
            {    
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setRollnum(detailPanel.geteMailField().getText());
        ...
        choiceListener = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String mobile = contactDetailsPanel.getMobileField().getText();
                String email = contactDetailsPanel.geteMailField().getText(); 
               String rollnum = contactDetailsPanel.getRollnumField().getText();
                
                flag = validate();
                if(flag)
                {    
                Person person = new Person();
                person.setData(name,mobile,email,city,rollnum);
